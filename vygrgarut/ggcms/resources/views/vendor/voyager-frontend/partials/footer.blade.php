             ...
             <div class="grid-x" style="color:white;">
                 ...
                 <div class="columns small-4 large-7 medium-text-center show-for-medium" style="padding-left:15px;padding-right:15px">
                     ...
                     <a onclick="window.open('{{ setting('site.link_instagram') }}');" href="#"
                         ...
                         {{ setting('site.instagram') }}</a>
                     <a onclick="window.open('{{ setting('site.link_twitter') }}');" href="#" style="color:white"><img
                             src="/storage/settings/April2021/twitter.png" width="16px">
                         {{ setting('site.twitter') }}</a>
                     <a onclick="window.open('{{ setting('site.link_youtube') }}');" href="#" style="color:white"><img
                             src="/storage/settings/April2021/yt.png" width="16px"> {{ setting('site.youtube') }}</a>
                     <br>
                     <div class="grid-x" style="color:white;">
