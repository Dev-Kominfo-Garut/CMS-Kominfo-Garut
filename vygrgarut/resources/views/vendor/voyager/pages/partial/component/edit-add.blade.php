...
<div class="page-content container-fluid">
    <form class="form-edit-add" role="form"
        action="@if($edit){{ route('component.update', $dataTypeContent->id) }}@else{{ route('component.store', $pageId) }}@endif"
        method="POST" enctype="multipart/form-data">
        <!-- PUT Method if we are editing -->
        @if($edit)
        {{ method_field("PUT") }}
        <input type="hidden" name="order" value="{{ $dataTypeContent->order }}">
        <input type="hidden" name="created_at" value="{{ $dataTypeContent->created_at }}">
        @endif
        {{ csrf_field() }}
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="panel">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="voyager-character"></i> {{ __('component.title') }}
                ...
                <div class="panel">
                    <div class="panel-heading">
                        <h3 class="panel-title">{{ __('component.description') }}</h3>
                        <div class="panel-actions">
            ...
            <div class="col-md-4">
                ...
                <div class="panel panel panel-bordered panel-warning">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-clipboard"></i> {{ __('component.details') }}
                        </h3>
                        <div class="panel-actions">
                            <a class="panel-action voyager-angle-down" data-toggle="panel-collapse"
                                aria-hidden="true"></a>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="status">
                                <option value="active" @if(isset($dataTypeContent->status) &&
                                    $dataTypeContent->status == 'active')
        ...
        {{-- <div class="panel panel-bordered panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="icon wb-image"></i> {{ __('component.image') }}</h3>
        <div class="panel-actions">
...
<button type="submit" class="btn btn-primary pull-right">
    @if($edit){{ __('component.edit') }}@else <i class="icon wb-plus-circle"></i>
    {{ __('component.create_new') }} @endif
</button>
@stop
